  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https:pm-s3-pics.s3.us-east-2.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https:pm-s3-pics.s3.us-east-2.amazonaws.com/${task.assignee?.profilePictureUrl}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https:pm-s3-pics.s3.us-east-2.amazonaws.com/${task.author?.profilePictureUrl}`}
